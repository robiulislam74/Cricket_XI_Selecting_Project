  ...
  return (
   <div>
     <div className='bg-gray-950 h-auto border-b border-gray-900 md:text-left text-left lg:p-0 p-8'>
      <div className='md:pt-60 pt-40 container mx-auto'>
        <img className='mx-auto' src={footerLogo} alt="" />
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-40 pt-10 md:pt-16 md:mb-16 mb-10'>
        <div>
        ...
        <div>
            ...
            <ul className=' text-gray-500 leading-relaxed pt-4 md:list-disc md:ml-4'>
                <li>Home</li>
                <li>Services</li>
                <li>About</li>
                <li>Contact</li>
